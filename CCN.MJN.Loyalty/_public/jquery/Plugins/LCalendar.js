    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl">' +
                '<div class="date_roll_mask clearfix">' +
                '<div class="parent">'+
                '<div class="child">'+
                '<div class="date_roll">' +
                '<div class="date_yy_wrap">' +
                '<div class="gear date_yy" data-datetype="date_yy"></div>' +
                '<div class="date_grid">' +
                '<div>年</div>' +
                '</div>' +
                '</div>' +
                '<div class="date_mm_wrap">' +
                ...
                '<button class="date_btn lcalendar_finish"></button>'+
                '</div>' ;
